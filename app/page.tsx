...
export default function Home() {
  return (
    ...
    for instant access to cutting-edge models from ASI, OpenAI, Deepseek and more.
      ...
      <Link target="_blank" href={"https://ethereum-inference-network-fe.vercel.app"}
        className="rounded-2xl text-lg px-8 py-4 bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70 shadow-lg hover:shadow-xl transition-all duration-300"
      >
      Try Demo
      </Link>
      <Link
      href={"/open-router"}
      className="rounded-2xl text-lg px-8 py-4 border-primary/60 hover:border-primary/50 hover:bg-primary/5 transition-all duration-300"
      >
      View Models
      </Link>
      </div>
